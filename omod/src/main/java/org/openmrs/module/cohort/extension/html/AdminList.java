...
public class AdminList extends AdministrationSectionExt {
	...
	public Map<String, String> getLinks() {
		...
		map.put("/module/cohort/cohortattributesmanage.form","Manage Cohort Attributes");
		map.put("/module/cohort/cohortenc.form","Manage Cohort Encounters");
		map.put("/module/cohort/cohortmemberattributemanage.form","Manage Cohort Member Attributes");
		map.put("/module/cohort/cohortmemberattributetypemanage.form", "Manage Cohort Member Attribute Type");
