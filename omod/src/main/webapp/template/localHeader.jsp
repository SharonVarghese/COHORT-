...
<ul id="menu">
	...
	<li
	   ...
	   <a href="${pageContext.request.contextPath}/module/cohort/configurecohortmetadata.form">Configure Cohort Metadata</a>
	   </li>
	 <li
		<c:if test='<%= request.getRequestURI().contains("/cohortattributesmanage") %>'>class="active"</c:if>>
	   <a href="${pageContext.request.contextPath}/module/cohort/cohortattributesmanage.form">Manage Cohort Attributes</a>
	   </li>  
	<li
	...
	<li
		<c:if test='<%= request.getRequestURI().contains("/cohortmemberattributemanage") %>'>class="active"</c:if>>
	<a href="${pageContext.request.contextPath}/module/cohort/cohortmemberattributemanage.form">Manage Cohort Member Attribute</a>
	</li>
	<li
		<c:if test='<%= request.getRequestURI().contains("/cohortmemberattributetypemanage") %>'>class="active"</c:if>>
	<a href="${pageContext.request.contextPath}/module/cohort/cohortmemberattributetypemanage.form">Manage Cohort Member Attribute Type</a>
	</li>
	<li
